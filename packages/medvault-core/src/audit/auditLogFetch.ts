...
import startBlocks from "../../data/sepolia-start-blocks.json" with { type: "json" };
...
/** Ethereum Sepolia deploy block for DataAccessLog (see data/sepolia-start-blocks.json). */
